...
import { ArrowRight, BookOpen, CheckCircle2, Library } from "lucide-react";
          ...
          <div>
            ...
            <div className="mt-7 flex flex-col gap-3 sm:flex-row">
              ...
              <Button asChild variant="outline" size="lg">
                <Link href="/pdf-tools">Browse PDF tools</Link>
              </Button>
            </div>
          </div>
      ...
      <div className="mx-auto grid w-full max-w-7xl gap-10 px-4 py-12 sm:px-6 lg:grid-cols-[minmax(0,1fr)_340px] lg:px-8">
        <div className="space-y-12">
          ...
          {guide.quickSteps?.length ? (
            ...
            >
              <h2 id="quick-steps" className="text-2xl font-bold">
        ...
        <aside className="lg:sticky lg:top-24 lg:h-fit">
          <div className="rounded-3xl border border-border bg-card p-5 shadow-sm">
            ...
            <p className="mt-2 text-sm leading-6 text-muted-foreground">
              Use this guide as a starting point, then move to the tool or
              topic that matches your file.
            </p>
          ...
          <nav
            aria-label="Related learning resources"
