          ...
          <div>
            ...
            <div className="mt-7 flex flex-col gap-3 sm:flex-row">
              ...
              <Button asChild variant="outline" size="lg">
                <Link href="/pdf-image-tools">Browse image tools</Link>
              </Button>
            </div>
            <div className="mt-6 grid gap-3 text-sm text-muted-foreground sm:grid-cols-3">
              <TrustPill icon={MonitorCheck} text="Works in your browser" />
              <TrustPill icon={LockKeyhole} text="Private by design" />
              <TrustPill icon={FileImage} text="Layout preview" />
            </div>
          </div>
        ...
        <aside className="lg:sticky lg:top-24 lg:h-fit">
          <div className="rounded-3xl border border-border bg-card p-5 shadow-sm">
            ...
            <p className="mt-2 text-sm leading-6 text-muted-foreground">
              Turn JPG images into a clean PDF with live layout preview.
            </p>
          ...
          <nav
            aria-label="Related image and PDF tools"
